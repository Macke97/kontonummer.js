...
var validate = function(accnum, bank) {
    ...
    let number =
        ...
        bank.type === 1
            ...
            bank.type === 2 && bank.comment === 2
            ? accnum.substr(-9)
            : // Swedbanks konton av typ 2
            bank.type === 2 && bank.comment === 3 && accnum.charAt(0) === '8'
            ? accnum.substr(5)
            : // Plusgirots konton av typ 2
            bank.type === 2 && bank.comment === 3 && accnum.charAt(0) === '9'
            ? accnum.substr(4)
    ...
    let modResult =
        bank.type === 1 && bank.comment === 1
            ? mod11((clearing + number).substr(-10))
            : bank.type === 1 && bank.comment === 2
            ? mod11(clearing + number)
            : bank.type === 2 && bank.comment === 2
            ? mod11(number)
